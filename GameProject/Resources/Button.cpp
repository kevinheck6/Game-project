...
gui::TextureSelector::TextureSelector(float x, float y, float width, float height, float gridSize,
    ...
    this->bounds.setPosition(x - 8, y + offset);
    this->bounds.setFillColor(sf::Color(50,50,50, 100));
    this->bounds.setOutlineThickness(1.f);
    this->bounds.setOutlineColor(sf::Color(255, 255, 255, 200));

    this->texture.setTexture(*texture_sheet);
    this->texture.setPosition(x - 8, y + offset);
    ...
    this->selector.setPosition(x - 5 + offset, y);
...
void gui::TextureSelector::update(const sf::Vector2i& mousePosWindow, const float& dt) {
    ...
    if(!this->hidden) {
        ...
        if(this->active) {
            ...
            this->textureRectangle.left = static_cast<int>(this->selector.getPosition().x) -
                                          static_cast<int>(this->bounds.getPosition().x);
            this->textureRectangle.top = static_cast<int>(this->selector.getPosition().y) -
